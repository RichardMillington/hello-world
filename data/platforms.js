const platforms = [
  {
    ...
    verdict:"Declining. Post-acquisition quality and support have deteriorated significantly",verdictType:"declining",momentum:"rapid-declining",website:"https://khoros.com",
    featureCompleteness:9,featureDepth:6.5,easeOfUse:6.5,qualityOfFeatures:6,integrations:8,dataPrivacySecurity:9,servicesSupport:5.5,reportsAnalytics:6,
    scoreExplainers:{
      featureCompleteness:"Forums, Q&A, ideation, KB, blogs, gamification, mobile app, 37+ languages. Only missing native events.",
      featureDepth:"Average of 9 feature categories from detailed analysis. Strongest: Discussions & Q&A (8), Moderation (8). Weakest: Events (1), Mobile (6).",
  ...
  },
  {
    ...
    featureCompleteness:7.5,featureDepth:6.5,easeOfUse:6.5,qualityOfFeatures:8,integrations:7.5,dataPrivacySecurity:8,servicesSupport:8,reportsAnalytics:7,
    scoreExplainers:{
      featureCompleteness:"Forums, Q&A, ideation, KB, product updates hub, gamification, events. No native mobile app or blogs.",
      featureDepth:"Average of 9 feature categories from detailed analysis. Strongest: Ideation (8), Moderation (8). Weakest: Mobile (3), Events (3).",
      easeOfUse:"Reasonable setup but not drag-and-drop simple. Admin dashboard is functional. Configuration takes time, especially with Gainsight CS integration.",
      ...
      dataPrivacySecurity:"Standard enterprise security. GDPR compliant. Less documented than Khoros or Salesforce.",
      servicesSupport:"IDC MarketScape Leader. Dedicated CSM. Strong onboarding. Responsive support team.",
      reportsAnalytics:"Community health dashboards. Subscription analytics added Q1 2026. Engagement scoring via Gainsight CS."
    },
    execution:{
    ...
    editorial:"Gainsight, alongside Higher Logic, is one of the two big movers in the space at the moment. Its inSided heritage gives it solid community fundamentals, and the Gainsight integration creates a genuinely unique value proposition. Your community activity feeds directly into customer health scores. Gainsight is broadly known as a robust platform with a great feature set, albeit a little less customisation than other experiences. Be mindful, however, that some of the newer features (multiple search connectors, AI features, etc.) are packaged up as additional extras which may increase the fee."
  },
  {
    ...
    featureCompleteness:8.5,featureDepth:6.0,easeOfUse:7,qualityOfFeatures:8,integrations:7.5,dataPrivacySecurity:8,servicesSupport:8,reportsAnalytics:7.5,
    scoreExplainers:{
      featureCompleteness:"Strong core: forums, Q&A with accepted answers, ideation, KB, gamification, AI search, Widget Builder. Missing blogs, events, and mobile app but deep where it matters.",
      featureDepth:"Average of 9 feature categories from detailed analysis. Strongest: Discussions & Q&A (8), Content & Knowledge (7). Weakest: Mobile (3), Events (3).",
  ...
  },
  {
    ...
    featureCompleteness:9,featureDepth:6.0,easeOfUse:3,qualityOfFeatures:3.5,integrations:8.5,dataPrivacySecurity:9.5,servicesSupport:5,reportsAnalytics:5,
    scoreExplainers:{
      ...
      featureDepth:"Average of 9 feature categories from detailed analysis. Strongest: Content & Knowledge (8), AI Features (8). Weakest: Events (3), Ideation (4).",
      ...
      qualityOfFeatures:"Salesforce has essentially stopped developing the community platform. Features exist on paper but the UX is years behind dedicated vendors. Feels abandoned.",
      integrations:"Native Salesforce ecosystem access is the one real strength. But community-specific integrations with third-party tools lag behind dedicated platforms.",
      dataPrivacySecurity:"Enterprise-grade. SOC 2, HIPAA-capable, FedRAMP. The gold standard for regulated industries.",
      servicesSupport:"Support is impersonal and often routed through SI partners rather than Salesforce directly. Community-specific expertise is thin.",
      reportsAnalytics:"Salesforce reporting engine is powerful in theory but getting community-specific insights requires significant configuration. Out of the box, it's weak."
    },
    execution:{
  ...
  },
  {
    ...
    featureCompleteness:8.5,featureDepth:5.5,easeOfUse:6,qualityOfFeatures:7,integrations:7.5,dataPrivacySecurity:9,servicesSupport:7.5,reportsAnalytics:6,
    scoreExplainers:{
      featureCompleteness:"Forums, Q&A, ideation, KB, blogs, gamification, mobile app. No native events. Feature-rich but aging.",
      featureDepth:"Average of 9 feature categories from detailed analysis. Strongest: Content & Knowledge (7), Moderation (7). Weakest: Events (1), Ideation (4).",
      ...
      reportsAnalytics:"Case deflection analytics were once a strength but the reporting hasn't kept pace. Functional but dated compared to modern alternatives."
    },
    execution:{
  ...
  },
  {
    ...
    featureCompleteness:7,featureDepth:5.5,easeOfUse:7,qualityOfFeatures:8,integrations:7.5,dataPrivacySecurity:7,servicesSupport:7,reportsAnalytics:7,
    scoreExplainers:{
      ...
      featureDepth:"Average of 9 feature categories from detailed analysis. Strongest: Discussions & Q&A (7), Content & Knowledge (7). Weakest: Mobile (3), Events (3).",
      easeOfUse:"Decent setup with Design Studio for no-code customisation. Self-serve pricing. Not as intuitive as Circle or Mighty Networks but manageable.",
      ...
      dataPrivacySecurity:"Adequate but less mature than enterprise-focused vendors. Smaller security team.",
      servicesSupport:"Self-serve model. Docs and community support. No dedicated CSM on lower tiers.",
      reportsAnalytics:"Basic engagement analytics. Content performance tracking. Less sophisticated than enterprise platforms."
    },
    execution:{
    ...
    editorial:"Bettermode is a great choice for product communities, organisations with marketing goals, and those where engagement matters more than knowledge management. The feed/wall approach feels more like a modern social network than a traditional community, and for some use cases, that's exactly right. The GraphQL API and Design Studio give technical teams real flexibility, and the pricing is the most accessible in this comparison. It doesn't yet match the capabilities of the top vendors in this space, and isn't fully proven at the largest scales, but it's a very solid mid-market alternative."
  },
  {
    ...
    featureCompleteness:6.5,featureDepth:5.5,easeOfUse:6.5,qualityOfFeatures:7.5,integrations:7,dataPrivacySecurity:7.5,servicesSupport:8,reportsAnalytics:7.5,
    scoreExplainers:{
      ...
      featureDepth:"Average of 9 feature categories from detailed analysis. Strongest: Events (9), Analytics & Reporting (7). Weakest: Mobile (3), Gamification (4).",
      ...
      dataPrivacySecurity:"Enterprise-grade positioning. Security adequate for large community programmes.",
      servicesSupport:"Strong — owns CMX (community industry body). Responsive team. Good onboarding.",
      reportsAnalytics:"Event ROI attribution is excellent. Community analytics still developing."
    },
    execution:{
    ...
    editorial:"Bevy is a new entrant into the enterprise community platform space, albeit one with huge experience at running community events at scale. Bevy's community hub has a comparable feature set but not yet the depth of functionality offered by major enterprise vendors. However, it is catching up quickly to the major players in this space. It has a significantly faster development cycle and is already pulling ahead in several AI capabilities."
  },
  {
    ...
    featureCompleteness:6,featureDepth:4.5,easeOfUse:7.5,qualityOfFeatures:7,integrations:6,dataPrivacySecurity:8,servicesSupport:6.5,reportsAnalytics:7,
    scoreExplainers:{
      ...
      featureDepth:"Average of 9 feature categories from detailed analysis. Strongest: Mobile (8), Content & Knowledge (5). Weakest: Ideation (1), Gamification (3).",
  ...
  },
  {
    ...
    featureCompleteness:6.5,featureDepth:6.0,easeOfUse:7,qualityOfFeatures:8.5,integrations:7.5,dataPrivacySecurity:8.5,servicesSupport:7,reportsAnalytics:6.5,
    scoreExplainers:{
      ...
      featureDepth:"Average of 9 feature categories from detailed analysis. Strongest: Discussions & Q&A (9), Moderation (8). Weakest: Events (1), Ideation (3).",
      easeOfUse:"Self-hosted requires sysadmin skills. Hosted version is straightforward. Plugin setup can be complex.",
      qualityOfFeatures:"Exceptional quality for what it does. Trust levels, real-time updates, chat channels, AI features, and markdown editor are all polished. The best forum UX available.",
      integrations:"WordPress, Slack, GitHub, Zendesk, Zapier, SSO. Plugin ecosystem extends further but quality varies.",
      dataPrivacySecurity:"Self-hosted means full data sovereignty. Good security defaults. You manage your own compliance.",
      servicesSupport:"Community-driven support. Enterprise tier gets SLA and priority. Self-hosted = you're on your own.",
      reportsAnalytics:"Basic community metrics. Less sophisticated than commercial platforms. Plugin ecosystem can extend."
    },
    execution:{
    ...
    editorial:"Discourse offers the most advanced forum option on the market with a wide range of unique features and deep customization functionality. It has excellent trust-level features, a unique plugin architecture, and offers a terrific experience for most admins. Discourse is a great option if your primary consideration is finding the best forum functionality. However, if you need more than a forum (content, courses, events, etc), other platforms are a better option."
  },
  {
    ...
    featureCompleteness:5.5,featureDepth:5.0,easeOfUse:7,qualityOfFeatures:7,integrations:5,dataPrivacySecurity:7,servicesSupport:4,reportsAnalytics:5.5,
    scoreExplainers:{
      featureCompleteness:"Core forums with basic gamification via extensions. No native Q&A, KB, ideation, events, or mobile app. Extension ecosystem adds some breadth but limited.",
      featureDepth:"Average of 9 feature categories from detailed analysis. Strongest: Moderation (7), AI Features (7). Weakest: Events (1), Ideation (3).",
      ...
      dataPrivacySecurity:"Self-hosted = you control data. Basic security. No enterprise compliance certifications.",
      servicesSupport:"Community support only. No commercial support option. You rely on GitHub issues and forums.",
      reportsAnalytics:"Minimal. Basic post/user stats. No engagement scoring, deflection metrics, or dashboards."
    },
    execution:{
    ...
    editorial:"Flarum is a lightweight alternative to Discourse which would serve smaller and less demanding communities well. The two-pane SPA interface is fast and elegant, and it strips back to essentials in a way that's refreshing. It's a solid choice for internal teams, small product communities, or hobbyist groups that want a clean forum without enterprise overhead. It won't ever be a serious threat to the major players in this space, but for its niche it does the job well."
  },
  {
    ...
    featureCompleteness:6,featureDepth:4.5,easeOfUse:9.5,qualityOfFeatures:5.5,integrations:6,dataPrivacySecurity:6.5,servicesSupport:5,reportsAnalytics:6.5,
    scoreExplainers:{
      ...
      featureDepth:"Average of 9 feature categories from detailed analysis. Strongest: Mobile (7), Content & Knowledge (6). Weakest: Gamification (1), Ideation (1).",
  ...
  },
  {
    ...
    featureCompleteness:7,featureDepth:4.5,easeOfUse:9,qualityOfFeatures:8,integrations:5.5,dataPrivacySecurity:6,servicesSupport:6.5,reportsAnalytics:5.5,
    scoreExplainers:{
      ...
      featureDepth:"Average of 9 feature categories from detailed analysis. Strongest: Mobile (8), Content & Knowledge (6). Weakest: Ideation (1), Gamification (3).",
      ...
      qualityOfFeatures:"Strong execution across community, courses, events, and branded apps. Mighty AI is genuinely well-implemented. Quality is consistently good.",
      ...
      servicesSupport:"Docs, community support, email. Mighty Pro gets dedicated success manager. Lower tiers are self-serve.",
      reportsAnalytics:"Basic activity and revenue analytics. Engagement scores. Less sophisticated than enterprise tools."
    },
    execution:{
  ...
  },
  {
    ...
    featureCompleteness:6,featureDepth:5.5,easeOfUse:8.5,qualityOfFeatures:8,integrations:5.5,dataPrivacySecurity:8,servicesSupport:7,reportsAnalytics:6.5,
    scoreExplainers:{
      ...
      featureDepth:"Average of 9 feature categories from detailed analysis. Strongest: Events (8), Content & Knowledge (7). Weakest: Ideation (1), Discussions & Q&A (4).",
      ...
      qualityOfFeatures:"What it does, it does well. Events are excellent, forums and content are polished, clubs/chapters are thoughtfully designed. Limited scope but high quality within it.",
      ...
      servicesSupport:"Knowledge base, product update events. Small team (1-10) may limit capacity. Founder-involved.",
      reportsAnalytics:"Event and engagement tracking. Real-time dashboards. Member segments. Depth unclear vs established tools."
    },
    execution:{
  ...
  },
  {
    ...
    verdict:"Dominant in associations. The AMS integration depth is unmatched",verdictType:"steady",momentum:"steady",website:"https://www.higherlogic.com/thrive/",
    featureCompleteness:7,featureDepth:5.0,easeOfUse:6,qualityOfFeatures:7,integrations:8,dataPrivacySecurity:8,servicesSupport:8,reportsAnalytics:7,
    scoreExplainers:{
      ...
      featureDepth:"Average of 9 feature categories from detailed analysis. Strongest: Analytics & Reporting (7), Discussions & Q&A (6). Weakest: Events (2), Mobile (3).",
      ...
      integrations:"Strong AMS integrations: iMIS, Personify, Nimble AMS, Aptify, Fonteva, netFORUM. Best in the association space but depth varies by AMS.",
      dataPrivacySecurity:"Enterprise-grade. Standard compliance. Good for associations handling member data.",
      servicesSupport:"3,000+ association customers. Strong onboarding and CSM. ASAE-endorsed.",
      reportsAnalytics:"Engagement scoring ties community to AMS data. Renewal predictions. Good ROI measurement."
    },
    execution:{
    ...
    editorial:"Higher Logic Thrive gets filed as 'the association platform,' and that undersells it. The real draw is breadth out of the box: a personalised feed, AI search that cites your own content, ideation, an LMS tie-in, micro-sites, and marketing automation in the same system. Re-engaging every member dormant for 90 days is a HubSpot project elsewhere; in Thrive you switch it on. The old knock was a clunky back end, now being rebuilt, and the front end does more than its reputation suggests. If you want a primarily support experience, this isn't the right fit. But if you want a broader, engaging experience, Thrive should be in your consideration set."
  }
];
...
const tableStakes = [
  {id:"forums",name:"Discussion forums or spaces",
   ok:"Flat posts with basic categories. No threading or real-time updates.",
   good:"Threaded replies, multiple boards, rich text editor, content pinning, sorting options.",
   great:"Real-time updates, infinite scroll, trust levels, chat channels alongside async discussion, wiki-mode posts.",
   ratings:{khoros:"great",gainsight:"good",higherlogic:"great",salesforce:"good",verint:"good",bettermode:"good",bevy:"ok",hivebrite:"ok",discourse:"great",flarum:"good",circle:"good",mighty:"good",gradual:"good",thrive:"good"}},
  {id:"profiles",name:"User profiles and accounts",
   ok:"Username, avatar, and basic bio. No activity history.",
   good:"Activity feed, badges, custom fields, member directory with search.",
   great:"Rich profiles with reputation scores, social links, professional info, member-to-member messaging, LinkedIn import.",
   ratings:{khoros:"good",gainsight:"good",higherlogic:"good",salesforce:"good",verint:"good",bettermode:"good",bevy:"good",hivebrite:"great",discourse:"great",flarum:"ok",circle:"good",mighty:"good",gradual:"great",thrive:"good"}},
  {id:"moderation",name:"Content moderation tools",
   ok:"Manual review only. Flag button sends an email to admin.",
   good:"Moderation queue with bulk actions, word filters, user-level trust controls.",
   great:"AI-powered auto-classification (approve/pending/trash), configurable rules, trust levels that auto-promote reliable members, audit trail.",
   ratings:{khoros:"good",gainsight:"great",higherlogic:"good",salesforce:"good",verint:"good",bettermode:"good",bevy:"ok",hivebrite:"ok",discourse:"great",flarum:"ok",circle:"ok",mighty:"ok",gradual:"ok",thrive:"good"}},
  {id:"sso",name:"Single Sign-On (SSO)",
   ok:"Social login only (Google/Facebook).",
   good:"SAML 2.0 or OIDC with one enterprise provider.",
   great:"Multi-provider SSO, Okta/Azure AD/custom IdP, seamless redirect, JIT provisioning, social + enterprise in parallel.",
   ratings:{khoros:"great",gainsight:"good",higherlogic:"good",salesforce:"great",verint:"great",bettermode:"good",bevy:"good",hivebrite:"good",discourse:"good",flarum:"ok",circle:"ok",mighty:"ok",gradual:"good",thrive:"great"}},
  {id:"search",name:"Search functionality",
   ok:"Basic keyword matching. Returns titles only.",
   good:"Full-text search with filtering by category, author, date. Relevant results.",
   great:"AI-powered semantic search, RAG-based answers from community content, suggested results, federated search across KB and docs.",
   ratings:{khoros:"good",gainsight:"good",higherlogic:"great",salesforce:"good",verint:"good",bettermode:"good",bevy:"ok",hivebrite:"ok",discourse:"great",flarum:"ok",circle:"good",mighty:"good",gradual:"ok",thrive:"good"}},
  {id:"admin",name:"Admin dashboard",
   ok:"Scattered settings pages. No overview or metrics.",
   good:"Unified settings with basic activity metrics and pending moderation count.",
   great:"Real-time health dashboard, engagement trends, configurable widgets, AI-generated insights, at-a-glance action items.",
   ratings:{khoros:"good",gainsight:"great",higherlogic:"good",salesforce:"good",verint:"good",bettermode:"good",bevy:"good",hivebrite:"good",discourse:"good",flarum:"ok",circle:"good",mighty:"good",gradual:"good",thrive:"good"}},
  {id:"analytics",name:"Basic analytics / reporting",
   ok:"Page views and post counts. No export.",
   good:"Engagement dashboards, top contributors, content performance, CSV export.",
   great:"Case deflection metrics, ROI measurement, member retention cohorts, sentiment analysis, API access to all data, custom reports.",
   ratings:{khoros:"good",gainsight:"good",higherlogic:"good",salesforce:"great",verint:"good",bettermode:"good",bevy:"good",hivebrite:"ok",discourse:"ok",flarum:"ok",circle:"ok",mighty:"ok",gradual:"ok",thrive:"good"}},
  {id:"branding",name:"Custom branding / theming",
   ok:"Logo upload and primary colour picker.",
   good:"Custom CSS, colour themes, custom domain, email template branding.",
   great:"Full white-label (no vendor branding), custom domains, branded mobile apps, design studio / drag-and-drop page builder.",
   ratings:{khoros:"good",gainsight:"good",higherlogic:"good",salesforce:"great",verint:"good",bettermode:"great",bevy:"good",hivebrite:"great",discourse:"good",flarum:"good",circle:"good",mighty:"great",gradual:"great",thrive:"good"}},
  {id:"email",name:"Email notifications",
   ok:"All-or-nothing. Every post triggers an email.",
   good:"Per-category subscribe/unsubscribe. Daily or weekly digest option.",
   great:"Granular preferences, smart frequency capping, personalised digest content, triggered automation sequences, HTML-customisable templates.",
   ratings:{khoros:"good",gainsight:"good",higherlogic:"good",salesforce:"good",verint:"good",bettermode:"good",bevy:"ok",hivebrite:"good",discourse:"good",flarum:"ok",circle:"good",mighty:"good",gradual:"ok",thrive:"great"}},
  {id:"permissions",name:"Role-based permissions",
   ok:"Two roles: admin and member.",
   good:"Custom roles with per-section permissions. Moderator role available.",
   great:"Granular per-category and per-content-type permissions, group-based access, inherited role hierarchies, API-managed roles.",
   ratings:{khoros:"great",gainsight:"good",higherlogic:"good",salesforce:"great",verint:"good",bettermode:"good",bevy:"good",hivebrite:"good",discourse:"great",flarum:"ok",circle:"good",mighty:"good",gradual:"good",thrive:"good"}},
  {id:"mobile",name:"Mobile-responsive design",
   ok:"Desktop layout that mostly works on mobile. Some broken elements.",
   good:"Properly responsive design. Readable and navigable on all screen sizes.",
   great:"Native mobile app or PWA with push notifications, offline support, touch-optimised interactions, branded app store listing.",
   ratings:{khoros:"great",gainsight:"good",higherlogic:"good",salesforce:"great",verint:"great",bettermode:"good",bevy:"good",hivebrite:"great",discourse:"good",flarum:"good",circle:"great",mighty:"great",gradual:"great",thrive:"ok"}},
  {id:"api",name:"API access",
   ok:"A few read-only endpoints. Minimal documentation.",
   good:"REST API with CRUD operations. Reasonable documentation. Webhooks available.",
   great:"Full REST or GraphQL API, comprehensive docs with examples, SDKs, webhooks, headless/embedded mode, generous rate limits.",
   ratings:{khoros:"good",gainsight:"good",higherlogic:"great",salesforce:"great",verint:"good",bettermode:"great",bevy:"good",hivebrite:"good",discourse:"great",flarum:"good",circle:"good",mighty:"ok",gradual:"ok",thrive:"good"}},
  {id:"registration",name:"User registration flows",
   ok:"Email and password only. No customisation of the flow.",
   good:"Custom profile fields at signup. Email verification. Social login options.",
   great:"Approval workflows, invite-only mode, progressive profiling, onboarding sequences, LinkedIn profile import, conditional fields.",
   ratings:{khoros:"good",gainsight:"good",higherlogic:"good",salesforce:"great",verint:"good",bettermode:"good",bevy:"good",hivebrite:"great",discourse:"good",flarum:"ok",circle:"good",mighty:"good",gradual:"good",thrive:"good"}},
  {id:"flagging",name:"Content flagging / reporting",
   ok:"Flag button. Admin gets a notification. No tracking.",
   good:"Categorised reports (spam, abuse, off-topic). Moderation queue for flagged items.",
   great:"Automated escalation rules, reporter feedback on resolution, appeals process, pattern detection for repeat offenders, resolution analytics.",
   ratings:{khoros:"good",gainsight:"great",higherlogic:"good",salesforce:"good",verint:"good",bettermode:"good",bevy:"ok",hivebrite:"ok",discourse:"great",flarum:"ok",circle:"ok",mighty:"ok",gradual:"ok",thrive:"good"}},
  {id:"gdpr",name:"GDPR / privacy controls",
   ok:"Cookie banner. Manual data deletion on request.",
   good:"Data export available. Consent management. Privacy policy integration. DPA available.",
   great:"Automated data export/deletion, data residency options, audit logs, privacy-by-design architecture, SOC 2 / ISO certification, configurable retention policies.",
   ratings:{khoros:"great",gainsight:"good",higherlogic:"good",salesforce:"great",verint:"great",bettermode:"good",bevy:"good",hivebrite:"good",discourse:"good",flarum:"ok",circle:"ok",mighty:"ok",gradual:"good",thrive:"good"}}
];
...
const weightHints={
  ...
  featureDepth:{
    0:"Not important",
    1:"Barely matters",2:"Barely matters",
    3:"Minor — basic implementations are fine",4:"Minor factor",
    5:"Moderate — features should be solid and functional, not just checkboxes",
    6:"Important — we need well-executed features, not just 'has it on paper'",
    7:"High priority — feature quality and depth matter as much as breadth",
    8:"Very high — we need best-in-class execution across discussions, moderation, search, and content",
    9:"Critical — shallow features are worse than missing ones. Depth is everything",
    10:"Our top priority — we'd rather have fewer features done exceptionally well"
  },
  easeOfUse:{
    0:"Not important",
    1:"Barely matters",2:"Barely matters",
